...
class Configuration:
    def __init__(self, path):
        ...
        self.is_multi_task = self.get_config_attribute("multi", "is_multi_task", bool, False)
        self.main_task = self.get_config_attribute("multi", "main_task", default_val="crf")
        self.auxiliary_task = self.get_config_attribute("multi", "auxiliary_task", default_val="softmax")
